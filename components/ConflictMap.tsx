    ...
    <Card className="bg-neutral-900/50 border-neutral-800 overflow-hidden">
        ...
        <div className="flex items-center justify-between mb-2">
          <div>
            ...
            <p className="text-sm text-neutral-400 mt-1">
              Interactive visualization of reported events
            </p>
          </div>
      ...
      <div className="p-5 border-t border-neutral-800">
        <h4 className="text-sm font-medium text-white mb-3 flex items-center justify-between">
          <span>Recent Verified Events</span>
          {events.length > 0 && (
        ...
        {loading ? (
          ...
          <p className="text-sm text-neutral-500 text-center py-4">No recent events</p>
        ) : (
        ...
        <div className="mt-4 pt-4 border-t border-neutral-800">
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="flex items-center gap-2">
              ...
              <span className="text-neutral-400">Critical (8-10)</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-orange-500" />
              <span className="text-neutral-400">High (6-7)</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-yellow-500" />
              <span className="text-neutral-400">Medium (4-5)</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-blue-500" />
              <span className="text-neutral-400">Low (1-3)</span>
            </div>
          </div>
        </div>
      </div>
